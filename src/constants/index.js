...
const expCards = [
  ...
  },
  {
    ...
    responsibilities: [
      "Slow-cooked the oxtail to tender, rich flavor.",
      "Set up the buffet line and restocked sides throughout service.",
      "Greeted guests and made sure every plate felt welcoming.",
    ],
  },
];
